...
class GoodListStore{
  ...
  @action
  setIsShowDetailPage(isShowDetailPage){
  ...
  get currentIndex(){
    for (let i = 0; i < this.listHeight.length; i++) {
      ...
      if (!height2 || (this.goodPositionY >= height1 && this.goodPositionY < height2)) {
        return i;
      }
    }
    return 0;   
  ...
  @action
  changeGoodPositionY(y){
    this.goodPositionY=y;
  }

  @action
  changeListHeight(listHeight){
