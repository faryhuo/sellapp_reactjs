...
class RatingStore {
  ...
  get ratingContent(){
    ...
    return this.data.filter((rating)=>{
      return (rating.rateType===this.ratingType && (!this.isOnlyContent || rating.text));
  });
  }

  @action
  setIsOnlyContent(isOnlyContent){
